    ...
    useEffect(() => {
        ...
        switch (selectedMonth) {
            ...
            case 'february':
                ...
                ((y % 400 === 0) || (y % 4 === 0 && y % 100 !== 0)) ? monthLength = 29 : monthLength = 28;
                break;
    ...
    useEffect(() => {
        if (studentIdNo.length === 7) {
            fetch(`https://hidden-sea-34919.herokuapp.com/studentInfo/${studentIdNo}`, {
                ...
                .then(data => {
                    if (data.studentName) {
                        setErrorMessage(`Student already updated with the name ${studentName}`);
                ...
                <Form onSubmit={handleUpdateStudent}>
                    ...
                    <Form.Group className="mb-3" controlId="obtainedGPA">
                        ...
                        <div className="d-flex gap-2">
                            <Form.Select aria-label="year" name='year' required onChange={e => setSelectedYear(e.target.value)}>
                            ...
                            <Form.Select aria-label="month" name='month' required onChange={e => setSelectedMonth(e.target.value)}>
                    ...
                    <Button variant="secondary" type="submit" className='mx-auto d-block' disabled={studentName}>
                        Update Result
                    </Button>
                </Form>
            </div >
